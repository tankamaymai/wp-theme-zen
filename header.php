    ...
    <?php echo get_theme_mod('mytheme_main_header_section_text_color') ? 'color: ' . get_theme_mod('mytheme_main_header_section_text_color') . ';' : ''; ?>">
        <div class="site-branding">
            <?php if (has_custom_logo()) {
                ...
                <h1 class="site-title"><a href="<?php echo esc_url(home_url('/')); ?>" rel="home" style="<?php echo get_theme_mod('mytheme_main_header_section_text_color') ? 'color: ' . get_theme_mod('mytheme_main_header_section_text_color') . ';' : ''; ?>"><?php bloginfo('name'); ?></a></h1>
            <?php } ?>
