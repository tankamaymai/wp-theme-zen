(function (blocks, element, blockEditor, components, data) {
  ...
  blocks.registerBlockType("zen/faq", {
      ...
      edit: function (props) {
          ...
          var { replaceInnerBlocks } = useDispatch('core/block-editor');
          ...
          function addItem() {
              var newItems = [...faqItems, { id: Date.now().toString(), question: '', content: '' }];
                              ...
                              el(
                                  ...
                                  el(
                                      ...
                                      el(Button, {
                                          ...
                                          onClick: function() {
                                              var newBlocks = [
                                                  createBlock('core/paragraph', { content: '回答を入力してください' })
                                              ];
                                              replaceInnerBlocks(clientId + '-answer-' + index, newBlocks, false);
                                          }
                                      }, "回答を編集")
                                  )
                              ),
